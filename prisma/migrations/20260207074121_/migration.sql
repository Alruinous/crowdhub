...
INSERT INTO "new_annotations" ("completedCount", "createdAt", "finalResult", "id", "needToReview", "publishedCount", "requiredCount", "requirementVector", "resultConfirmed", "rowData", "rowIndex", "status", "taskId", "updatedAt", "vectorLength") SELECT "completedCount", "createdAt", "finalResult", "id", "needToReview", "publishedCount", "requiredCount", "requirementVector", "resultConfirmed", "rowData", "rowIndex", "status", "taskId", "updatedAt", "vectorLength" FROM "annotations";
