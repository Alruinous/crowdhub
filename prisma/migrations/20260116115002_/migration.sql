...
INSERT INTO "new_annotations" ("completedCount", "createdAt", "id", "isfinished", "publishedCount", "requiredCount", "requirementVector", "rowData", "rowIndex", "status", "taskId", "updatedAt", "vectorLength") SELECT "completedCount", "createdAt", "id", "isfinished", "publishedCount", "requiredCount", "requirementVector", "rowData", "rowIndex", "status", "taskId", "updatedAt", "vectorLength" FROM "annotations";
